...
class LanguageContainer extends Component {
  ...
  componentDidMount () {
    ...
    this.bindAsArray(firebase.child('language_tutorials/' + id).limitToFirst(10), 'tutorials')
    this.bindAsArray(firebase.child('language_projects/' + id).limitToFirst(10), 'projects')
  }
